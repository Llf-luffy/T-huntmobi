export default {
  ...
  login: {
    title: 'バックステージ管理システム', // 后台管理系统
    account: 'アカウント', // 账户
    password: 'パスワード', // 密码
    veCificationCode: '検証コード', // 验证码
    notAccount: 'ユーザー名は空にできません', // 用户名不能为空
    notPassword: 'パスワードは空白にできません', // 密码不能为空
    notVeCificationCode: '確認コードを入力する必要があります', // 验证码不能为空
    login: 'ログインする', // 登录
    loginIn: 'ログイン...', // 登录中...
    remember: '私を覚えてますか' // 记住我
  },
  view: {
    title: '言語の切り替えに成功しました' // 切换语言成功
  },
  documentation: {
    documentation: 'ドキュメント',
    github: 'Github Link'
  ...
  settings: {
    title: 'システムテーマ', // 系统布局配置
    theme: 'テーマ色', // 主题色
    skin: 'ピーリング', // 换肤
    showHeader: 'ヘッドガイド', // 头部导航
    tagsView: 'Tags-View 開く', // 开启 Tags-View
